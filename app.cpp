...
int main()
{
    ...
    // auto server_error_callback = [](std::shared_ptr<hamza_socket::socket_exception> e)
    // {
    ...
    // auto on_client_connect = [](const std::shared_ptr<hamza_socket::socket> &client_socket)
    // {
    //     // std::cout << "Client connected: " << client_socket->get_bound_address() << std::endl;
    // };

    // auto on_client_disconnect = [](const std::shared_ptr<hamza_socket::socket> &client_socket)
    // {
    //     // std::cout << "Client disconnected: " << client_socket->get_bound_address() << std::endl;
    // };
