...
namespace hamza::http
{
    ...
    private:
        ...
        std::function<void(std::unique_ptr<hamza::general_socket_exception>)> error_callback;
    ...
    public:
        ...
        void set_error_callback(std::function<void(std::unique_ptr<hamza::general_socket_exception>)> callback);
    };
}