...
namespace hamza::web
{
    std::string web_request::trim(const std::string &str) const
    {
        try
        {
    ...
    web_request::web_request(http::http_request &&req)
        : request(std::move(req))
    {
    }

    std::vector<std::pair<std::string, std::string>> web_request::get_path_params() const
    {
    ...
    std::string web_request::get_path() const
    {
        try
        {
    ...
    std::vector<std::pair<std::string, std::string>> web_request::get_query_parameter(const std::string &name) const
    {
        try
        {
    ...
    std::string web_request::get_version() const
    {
        return request.get_version();
    }

    std::vector<std::string> web_request::get_header(const std::string &name) const
    {
        return request.get_header(name);
    }

    std::vector<std::pair<std::string, std::string>> web_request::get_headers() const
    {
        return request.get_headers();
    }

    std::string web_request::get_body() const
    {
        return request.get_body();
    }

    std::vector<std::string> web_request::get_content_type() const
    {
        return request.get_header(http::headers::CONTENT_TYPE);
    }

    std::vector<std::string> web_request::get_cookies() const
    {
        return request.get_header(http::headers::COOKIE);
    }

    std::vector<std::string> web_request::get_authorization() const
    {
